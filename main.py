def main():
    ...
    # Make FAA
    os.system("python %s/deps/FaaFromPrism.py %s %s" %
              (home_path, args.prism_input[0],faa_out))
    # Call InterPro
    os.system("python %s/deps/InterProRunner.py %s %s" %
              (home_path, faa_out, faa_out))
    # Convert InterPro
    os.system("python %s/deps/InterProParser.py %s %s" %
              (home_path, ip_out, args.interpro_output[0]))
    return 0
